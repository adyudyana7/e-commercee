...
const Footer = () => {
  return (
    <div className="tw-px-[195px]">
      <div className="tw-flex tw-justify-between tw-items-center tw-pb-12 tw-pt-32">
        <h2 className="tw-font-extrabold">Bandage</h2>
        <div className="tw-text-[#23A6F0]">
          <Facebook className="tw-pr-1" />
          <Instagram className="tw-pr-2" />
          <Twitter className="tw-pr-2" />
        </div>
      </div>
